...
import {
  Bot, Plus, Send, Settings2, X, RotateCcw, AlertTriangle,
  Loader2, Sparkles, Paperclip, Download,
} from 'lucide-react';
...
import {
  COLOR_CLASSES, ACCEPTED_FILE_TYPES, parseAssistantContent, triggerDownload,
} from '@/lib/chatbotUtils';
import { TypingIndicator, AttachmentChip, MessageAttachment } from '@/components/chatbots/ChatbotPieces';
import { BotDrawer } from '@/components/chatbots/BotDrawer';
